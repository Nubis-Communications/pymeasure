...
import sys
sys.path.append(r'C:\\work\\GitHub\\pymeasure\\pymeasure\\instruments\\agiltron')
...
meter = Agilent_PowerMeter('GPIB0::21::INSTR')
print(meter.idn())
print(meter.read_wavelength(2))
meter.set_power_unit(1,0)
meter.set_power_unit(2,0)
print(meter.read_cal_offset(2))
print(meter.PowerMeter(1))
