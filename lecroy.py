...
if __name__ == "__main__":
    ...
    # ip = resource_list[0]
    ip = "TCPIP::10.1.12.41::inst0::INSTR"
    ...
    scope.ch_2.set_vertical_scale(400e-3)  #! 80*8 = 640mV -> max range
    ...
    # start_time_ascii = time.perf_counter()
    ...
    # end_time_ascii = time.perf_counter()
    ...
    # print(f"{end_time_ascii-start_time_ascii}")
    print(f"{end_time_binary-start_time_binary}")
    ...
